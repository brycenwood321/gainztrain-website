...
//
// ⚠️ THE WINDOW IS PROVISIONAL (set 2026-08-09). Brycen's estimate is that prep is usually done around
// 11:00, pending confirmation with Jayson. Whatever it becomes, change it HERE and every message
...
export const PICKUP = {
  ...
  smsLine: 'Pickup Sun 11:00am-1:00pm, 149 N State St Ste B, Orem.',
};
